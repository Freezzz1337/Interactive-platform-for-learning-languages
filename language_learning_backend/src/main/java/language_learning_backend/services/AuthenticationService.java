...
import language_learning_backend.repositories.UserRepository;
import language_learning_backend.util.UserWithThisEmailAlreadyExistsException;
...
public class AuthenticationService {
    ...
    public User signup(RegisterDto input) {
        if (userRepository.findByEmail(input.getEmail()).isEmpty()) {
            ...
            user.setDateOfBirthday(input.getDateOfBirthday());
